    ...
    def create_optimizer(self):
        ...
        if self.optimizer is None:
            ...
            if self.args.mm_projector_lr is not None:
                # projector_parameters = [name for name, _ in opt_model.named_parameters() if "mm_projector" in name or "lm_head" in name or "norm" in name]
                projector_parameters = [name for name, _ in opt_model.named_parameters() if "mm_projector"]
